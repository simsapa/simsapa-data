...
synonyms = []
antonyms = []
see_also = ["ikkāsa", "ojā", "sajjulasa", "hiṅgu", "Ikkāsa", "lepa"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["assattha", "nigrodha", "pilakkha", "udumbara"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["kadalimiga", "kadalimiga"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["kalaka", "kalāya", "Sākhāmiga", "Sākhāssita"]
also_written_as = []
```
...
,1. Hindi *[kamala](/define/kamala)*, *Mallotus philippinensis* Ja.v.159, a medium\-sized tree with smooth grey bark, ovate leaves and large white flowers. A gland on the leaves gives a red powder which was used to dye silk.
...
synonyms = []
antonyms = []
see_also = ["makkaṭa", "makkaṭa", "Sākhāmiga", "Sākhāssita", "Vānara"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["kapittha", "assattha", "nigrodha", "pilakkha", "udumbara", "kacchaka"]
also_written_as = []
```
...
Blue Rock Pigeon, sometimes also *[pārāvata](/define/pārāvata)*, Hindi *kabutar* or *parawa*, *Columba livia* Ja.i.244. A familiar bird the world over, the blue rock pigeon is slate grey with a shining metallic green and purple sheen on its breast and neck and pink legs and eyes. The English name is due to the pigeon’s habit of nesting and roosting on cliffs and in rocky places. The pigeon is as much at home in lightly\-forested and open country as it is in villages and towns. The Buddha described old bones as being pigeon\-colored Dhp.149. One of the places around Rājagaha where monks sometimes used to stay was called Pigeon’s Cave Ud.39. According to the 5th Pillar Edict, King Asoka forbade the killing of white pigeons and village pigeons. The *Arthaśāstra* mentions tying messages to the pigeon’s legs. According to the Jātakas, the Bodhisattva was once reborn as a pigeon Ja.i.242.
...
synonyms = []
antonyms = []
see_also = ["kālasappa", "kālā", "Nāga", "Sappa."]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["Assattha", "Pilakkha", "Udumbara"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["Oluka", "Siṅgila", "Uhuṅkara", "Ulūka"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["suṃsumāra", "susumāra", "Gaha"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["apandara", "bala", "dhanka", "kākola", "vantāda", "vāyasa", "vanakāka", "Baḷīyakkha"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["halidda", "marica", "jīraka"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["adhipāta", "andhaka", "cīrilikā", "paṭanga", "salabha"]
also_written_as = []
```
...
Garlic, also *[ativisa](/define/ativisa)*, Hindi *lasun*, *Allium sativum* Vin.iv.34, an onion\-like herb emitting a strong odor, the bulbs of which can be eaten. Because of the strong smell it leaves on the breath which others could find offensive, the Buddha forbade monks eating garlic, although he allowed it to be taken for medicinal purposes Vin.ii.139. Garlic was sometimes also known as *Māgadhaka*, “of Magadha”, perhaps because it was commonly grown in that country Vin.iv.260. Indians have long considered garlic to be detrimental to both physical and spiritual well\-being. The *Manusmṛti* said that a brahmin will lose his caste if he eats garlic. After traveling through India in the 7th century, the Chinese pilgrim Xuanzang wrote: “Onions and garlic are little grown and few people eat them; if anyone uses them as food they are expelled beyond the walls of the town.”
...
synonyms = []
antonyms = []
see_also = ["ambuja", "vārija", "āli", "kālamaccha", "pāsāṇamacchaka", "satavaṃsa", "savaṃka"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["puḷava", "kimi", "gaṇḍuppādā"]
also_written_as = []
```
...
Perhaps *Sanseviera roxburghiana*, Bengali *murba* M.i.429, an erect fleshy plant with tufted leaves. The plant yields a very strong fiber that was still being used to make bow strings at the beginning of the 20th century.
...
synonyms = []
antonyms = []
see_also = ["barihin", "mora", "sikhandi", "nīlagīva"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["Nīlamaṇḍūka", "Uddhumāyikā"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["eṇi", "hariṇa", "issā", "issā", "Ajina"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["Isikā", "kaṭṭaka", "pabbaja", "Santha", "saravana"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["sappa", "Kaṇhasappa", "Sappa"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["karumbhaka", "rattasālī", "sāmāka", "Taṇḍula"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["ambuja", "kamala", "vārija", "puṇḍarīka", "uppala", "Sogandhika"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["sakuṇa", "najjuhā", "suka", "sāliya", "cakkavāka", "haṃsa"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["palasata", "Khagga"]
also_written_as = []
```

A type of animal, according to the commentaries, another name for the rhinoceros, sometimes *[palasata](/define/palasata)* or *phalasata* Ja.v.206 Ja.v.408 Ja.vi.277 Ja.vi.454. The *palasata* is mentioned in King Asoka’s 5th Pillar Edict as being a protected animal. See [Khagga](/define/Khagga).
...
synonyms = []
antonyms = []
see_also = ["kipillikā", "Kunthakipillaka", "Tambakipillika"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["pārevata", "Kakuṭa", "Kapota", "Pakkhima"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["sāra", "paṭṭa", "āluka", "kanda", "ojā", "tūla", "vakkala", "vakkala", "Vakkala", "Vakkala", "tirīṭa", "vakkala", "phalaka"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["rohitaruru", "rohita", "Rohicca"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["nāga", "alagadda", "Agārasappa", "Ajakara", "Deḍḍubha", "Kaṇhasappa", "Silābhu", "Udakasappa"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["jambukā", "kotthu", "siṅgāla"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["kallahāra", "sāluka", "sāluka", "Uppala"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["bhobhukka", "katthu", "kukkura", "suṇa", "supāṇa", "suvāṇa"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["jātisumanā", "mallikā", "vassikā", "yūthikā", "mallikā", "vassikā"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["Gaha", "Kumbhīla", "Susu", "Timi"]
also_written_as = []
```
...
Even in the middle of the 19th century Asiatic lions were still found in the less populated parts of the Middle East and northern India but today the last 300 or so are restricted to the Gir Forest in Gujarat. See [Kālasīha](/define/Kālasīha) and [Kesarī](/define/Kesarī).
...
synonyms = []
antonyms = []
see_also = ["nāga", "takkola", "Nimba", "Pūga"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["saddala", "jantu", "poṭakila", "kamala", "tiriyā", "eragu"]
also_written_as = []
```
...
synonyms = []
antonyms = []
see_also = ["veṇu", "vaṃsa", "Khuddakaveḷu", "Mahāveḷu"]
also_written_as = []
```
...
*Saraca indica* Ja.v.420, a medium\-sized tree with dark\-green leaves and beautiful orange and scarlet flowers. The 19th century botanist Roxburgh said of this tree “...when in full bloom, I do not think the whole vegetable kingdom affords a more beautiful object”.
...
synonyms = []
antonyms = []
see_also = ["kapi", "gonaṅgula", "tiṇḍuka"]
also_written_as = []
```
